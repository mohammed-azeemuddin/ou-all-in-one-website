        ...
        <SectionHeader data={sectionHeader} className="center-content" />
          <div className={tilesClasses}>
            ...
            <Link to={{
                  ...
                  state: { title: "Previous Engineering Question Papers ", dbName: "engineering_qp"}
              }}>
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Previous Engineering Question Papers
                  </p>
                </div>
              </div>
              </Link>
            ...
            <Link to={{
                  pathname: "/DisplayPage",
                  state: { title: "Previous Pharmacy Question Papers", dbName: "pharmacy_qp"}
              }}>
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  <div className="features-tiles-item-image mb-16">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Previous Pharmacy Question Papers
                  </p>
                </div>
              </div>
              </Link>
            ...
            <Link to={{
                  pathname: "/DisplayPage",
                  state: { title: "Previous BBA Question Papers", dbName: "bba_qp"}
              }}>
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  <div className="features-tiles-item-image mb-16">
            ...
            <Link to={{
                  pathname: "/DisplayPage",
                  state: { title: "Previous Law Question Papers", dbName: "law_qp"}
              }}>
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  <div className="features-tiles-item-image mb-16">
            ...
            <Link to={{
                  pathname: "/DisplayPage",
                  state: { title: "Previous Other Question Papers", dbName: "other_qp"}
              }}>
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  <div className="features-tiles-item-image mb-16">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Previous Other Question Papers
                  </p>
                </div>
              </div>
              </Link>
